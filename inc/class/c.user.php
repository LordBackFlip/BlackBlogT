...
class tsUser {
	...
	*/
	function loginUser($username = NULL, $password = NULL, $remember = FALSE, $redirectTo = NULL){
		global $tsCore;
	...
	*/
	function logoutUser($user_id = NULL, $redirectTo = '/'){
		global $tsCore;
		/* BORRAR SESSION */
        $this->session = new tsSession();
        $this->session->read();
...
class tsSession {
     ...
     * @param int
     */
	function set_cookie($name = NULL, $cookiedata = NULL, $cookietime = NULL)
	{
