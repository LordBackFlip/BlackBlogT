...
class tsMod {
    ...
    */
     ...
     * @return string
     */
    public function rebootPost($pid = NULL)
    {
        global $tsUser;
    ...
    public function OcultarPost($pid = NULL, $razon = NULL)
    {
        global $tsUser;
	...
	function rebootComunidad($comid = NULL) {
        global $tsUser;
        if ($tsUser->is_admod) {
	...
	function rebootTema($temaid = NULL) {
        global $tsUser;
        if ($tsUser->is_admod) {
	...
	public function deleteComunidad($comid = NULL){
	...
	public function deleteTema($temaid = NULL) {
        global $tsCore, $tsMonitor, $tsUser;
        if ($tsUser->is_admod) {
            // RAZON
            $razon = $tsCore->setSecure($_POST['razon']);
    ...
    public function deleteMps($mid = NULL)
    {
        global $tsCore, $tsMonitor, $tsUser;
    ...
    public function deleteFoto($fid = NULL)
    {
        global $tsCore, $tsMonitor, $tsUser;
     ...
     */
    public function setSticky($post_id = NULL){
        global $tsUser;
        //
     ...
     */
    public function setOpenClosed($post_id = NULL)
    {
        global $tsUser;
        //
     ...
     */
    public function banUser($user_id = NULL)
    {
        # GLOBALES
        global $tsUser, $tsCore;
        # LOCALES
     ...
     */
    public function rebootUser($user_id = NULL, $type = 'unban')
    {
        # GLOBALES
        global $tsUser;
     ...
     * @return string
     */
    public function setHistory($action = NULL, $type = NULL, $data = NULL)
    {
