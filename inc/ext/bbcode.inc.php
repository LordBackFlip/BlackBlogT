...
class BBCode {
    ...
    public function addBBcodes() {
        ...
        $tagCodes = array(
            ...
            array('tag' => 'img', 'replace' => '<img src="{param}" title="Imagen del posts"/>', 'parse' => false, 'validParam' => $imgValidator),
...
//        $pre = '<img src="'.$tsCore->settings['default'].'/images/smiles/';
		...
		$pre = '<img src="'.$tsCore->settings['default'].'/images/icons/smiles/';
        $end = '" align="absmiddle"/>';
		// SMILES DEFAULT
		...
		$bbcode[] = ":angry:"; $html[] = $pre."104.png".$end;
        $bbcode[] = ":mirada:"; $html[] = $pre."105.png".$end;
        $bbcode[] = ":okay:"; $html[] = $pre."106.png".$end;
        $bbcode[] = ":notbad:"; $html[] = $pre."107.png".$end;
        $bbcode[] = ":pokerface:"; $html[] = $pre."108.png".$end;
        $bbcode[] = ":truestory:"; $html[] = $pre."109.png".$end;
        $bbcode[] = ":falone:"; $html[] = $pre."110.png".$end;
        $bbcode[] = ":fuckyeahgirl:"; $html[] = $pre."111.png".$end;
        $bbcode[] = ":maybe:"; $html[] = $pre."112.png".$end;
        $bbcode[] = ":awyeah:"; $html[] = $pre."113.png".$end;
        $bbcode[] = ":good:"; $html[] = $pre."114.png".$end;
        $bbcode[] = ":umm:"; $html[] = $pre."115.png".$end;
        $bbcode[] = ":chac:"; $html[] = $pre."116.png".$end;
        $bbcode[] = ":friki:"; $html[] = $pre."117.png".$end;
        $bbcode[] = ":sadtroll:"; $html[] = $pre."118.png".$end;
        $bbcode[] = ":really:"; $html[] = $pre."119.png".$end;
        $bbcode[] = ":yuno:"; $html[] = $pre."120.png".$end;
        $bbcode[] = ":troll:"; $html[] = $pre."121.png".$end;
        $bbcode[] = ":yao:"; $html[] = $pre."122.png".$end;
        $bbcode[] = ":raisins:"; $html[] = $pre."123.png".$end;
        $bbcode[] = ":fapfap:"; $html[] = $pre."124.png".$end;
        $bbcode[] = ":fuckyeah:"; $html[] = $pre."125.png".$end;
        $bbcode[] = ":trolldad:"; $html[] = $pre."126.png".$end;
        $bbcode[] = ":happy:"; $html[] = $pre."127.png".$end;
        $bbcode[] = ":why:"; $html[] = $pre."128.png".$end;
        $bbcode[] = ":fuu:"; $html[] = $pre."129.png".$end;
        $bbcode[] = ":megusta:"; $html[] = $pre."130.png".$end;
        $bbcode[] = ":aww:"; $html[] = $pre."131.png".$end;
        $bbcode[] = ":cguy:"; $html[] = $pre."132.png".$end;
        $bbcode[] = ":motherofgod:"; $html[] = $pre."133.png".$end;
        $bbcode[] = ":lol:"; $html[] = $pre."134.png".$end;
        $bbcode[] = ":herp:"; $html[] = $pre."135.png".$end;
        $bbcode[] = ":no:"; $html[] = $pre."136.png".$end;
        $bbcode[] = ":happygirl:"; $html[] = $pre."137.png".$end;
