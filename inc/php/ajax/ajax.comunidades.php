...
\*********************************/
	...
	$files = array(
		...
		'comunidades-last-comentarios' =>  array('n' => 0, 'p' => 'last-comentarios'),		
		'comunidades-populares' =>  array('n' => 0, 'p' => 'top-populares'),
		'comunidades-temas-mas-visitados' =>  array('n' => 0, 'p' => 'top-visitados'),		
		'comunidades-ncorto' => array('n' => 2, 'p' => ''),
	);
...
\*********************************/
	...
	switch($action){
		...
		case 'comunidades-del_borrador':
			...
			//-->
		break;
		case 'comunidades-last-comentarios':
			$smarty->assign("tsRespuestas",$tsCom->getComensRecent());
		break;
		case 'comunidades-populares':
			$smarty->assign("tsPopulares",$tsCom->getPopulares());
		break;			
		case 'comunidades-temas-mas-visitados':
			include('../class/c.tops.php');
			$smarty->assign("tsVisitados",$tsCom->getVisitados());
		break;					
		case 'comunidades-ncorto':
			echo substr($tsCore->setSEO(strtolower($_POST['nombre'])), 0, 20);
		break;				
        default:
