...
\*********************************/
    ...
    switch($action){
        case '':
			...
			$tsTops = new tsTops();            
			$smarty->assign("Stats",$tsTops->getStats());
			//
        ...
        case 'agregar':
            if(!empty($_POST['titulo'])){
                ...
                if(!is_array($result) && $result > 0){
                    ...
                    $smarty->assign("tsAviso",array('titulo' => 'Imagen publicada', 'mensaje' => "La imagen <b>".$titulo."</b> fue agregada.", 'but' => 'Ver imagen', 'link' => "{$tsCore->settings['url']}/fotos/{$tsUser->nick}/{$result}/".$tsCore->setSEO($titulo).".html"));
                } else {
