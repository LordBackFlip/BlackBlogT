    		...
    		success: function(h){
    			switch(h.charAt(0)){
    				...
    				case '1': //OK
							...
							$('#messs').html('<div style="margin-top: 10px;" class="nada-amarillo">Tu comentario fue agregado correctamente</div>');
							$('.form').hide();
//                            $('.form').html('<div class="nada-amarillo">Tu comentario fue agregado correctamente :)</div>');
    						// SUMAMOS
...
//		mydialog.buttons(true, true, 'Eliminar ' + txt_type, 'fotos.del_' + txt_type + '(' + id + ')', true, true, true, 'Cancelar', 'close', true, false);
		mydialog.buttons(true, true, 'Aceptar ', 'fotos.del_' + txt_type + '(' + id + ')', true, true, true, 'Cancelar', 'close', true, false);
		mydialog.center();
    },
    // ELIMINAR COMENTARIO
