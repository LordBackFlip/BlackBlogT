...
//						$('#favorito_id_'+obj).css('opacity', '0.5');
...
$(document).ready(function(){
	...
	favoritos.template_favorito = '<div class="clfva" id="favorito_id___fav_id__"><div class="ttfa"><img src="'+ global_data.img +'images/icons/cat/__imagen__" title="__categoria_name__"/><a class="titlePost" title="__titulo__" href="__url__">__titulo__</a></div><div class="favp" title="__fecha_creado_formato__">__fecha_creado_palabras__</div><div class="favf" title="__fecha_guardado_formato__">__fecha_guardado_palabras__</div><div class="favpu" class="color_green">__puntos__</div><div  class="favc">__comentarios__</div><a class="elifav" id="change_status" href="" onclick="favoritos.eliminar(__fav_id__, this); return false;"><img src="' + global_data.img + 'images/borrar.png" alt="borrar" title="Borrar Favorito" /></a></div>';
