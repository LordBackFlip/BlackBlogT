            ...
            if(live.focus == true){
               ...
               setTimeout(function(){ live.hide(); }, live.hide_time);
                ...
                if(live.status['sound'] == 'ON'){
                    $('#swf').html('<embed width="0px" height="0px" wmode="transparent" allowscriptaccess="always" quality="high" bgcolor="#ffffff" src="' + global_data.url + '/inc/ext/' + sound_type + '.swf" type="application/x-shockwave-flash">');
                }
                // GLOBITOS
