					...
					<div class="sidebar-tabs clearbeta">
                        ...
                        <a onclick="avatar.edit(this)" class="boto azul" id="avatar-edit" style="width: 98px;text-align: center;margin: 0px 49px;">Editar</a>
                    </div>
                    <div class="clearfix"></div>
                    <h3 style="margin: 10px 0 0; padding: 0" id="porc-completado-label">Perfil completo al {$tsPerfil.porcentaje}%</h3>
