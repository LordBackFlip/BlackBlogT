	                            <h3 onclick="cuenta.chgsec(this)">Como soy</h3>
                                <fieldset style="display: none">
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="input-fake">
                                            <input type="text" value="{if $tsPerfil.p_altura}{$tsPerfil.p_altura}{/if}" maxlength="3" name="altura" id="altura" class="text cuenta-save-3"></div>
                                    </div>
                                    <div class="field">
                                        <label for="peso">Mi peso</label>
                                        <div class="input-fake">
                                            <input type="text" value="{if $tsPerfil.p_peso > 0}{$tsPerfil.p_peso}{/if}" maxlength="3" name="peso" id="peso" class="text cuenta-save-3"></div>
                                    </div>
                                    <div class="field">
                                    ...
                                    <div class="buttons">
                                        <input type="button" value="Guardar" onclick="cuenta.save(3, false)" class="boto verde" style="margin-right: 5px;">
										<input type="button" value="Siguiente" onclick="cuenta.save(3, true)" class="boto gris">
                                    </div>
                                </fieldset>