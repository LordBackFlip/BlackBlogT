<div class="tposts">
	<div class="izquierda" style="margin: 10px;width: 710px;">
		<div class="titular">
			<h2>Chat {$tsConfig.titulo}</h2>
		</div>
		<div class="box_cuerpo">	
			...
			{else}
				<div class="nada-gris">Estamos por agregar el chat para que puedas hacer nuevos amigos</div>
			{/if}		
		</div>	
	</div>
	<div class="derecha">
		<div id="protocolo" >	
			...
			<br /><br /><p style="text-align: center;padding: 0px; margin: 0px;" align="right">
