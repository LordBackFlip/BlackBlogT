	                            <h3 onclick="cuenta.chgsec(this)">Formaci&oacute;n y trabajo</h3>
                                <fieldset style="display: none">
                                        ...
                                        <div class="input-fake">
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    <select class="cuenta-save-4" name="idioma_{$iid}" style="width: 190px;">
                                    ...
                                    <div class="buttons">
                                        <input type="button" value="Guardar" onclick="cuenta.save(4, false)" class="boto verde" style="margin-right: 5px;">
										<input type="button" value="Siguiente" onclick="cuenta.save(4, true)" class="boto gris">
                                    </div>
                                </fieldset>