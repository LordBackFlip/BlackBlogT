	                            <h3 onclick="cuenta.chgsec(this)" style="margin: 20px 20px;">Intereses y preferencias</h3>
                                <fieldset style="display: none; margin: -20px 20px 20px 20px;">
                                    ...
                                    <div class="buttons">
                                        <input type="button" value="Guardar" onclick="cuenta.save(5)" class="boto verde">
                                    </div>
                                </fieldset>