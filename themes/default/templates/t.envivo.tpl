...
<script type="text/javascript" src="{$tsConfig.js}/envivo.js"></script>
<div class="tposts">
	<div class="izquierda">
	<div class="hh">
		<div class="titular">
	...
	<div class="derecha">
		<div class="boxposts separa">
			<div class="titular">
				...
				<div id="bvi"><input name="btn" id="btn" class="bpausa" type="button" value="PAUSA"/></div>
			</div>
			<div class="fbvi">			
				<label><input type="checkbox" id="Fposts" checked="checked">Posts</label>
				<label><input type="checkbox" id="Fshouts" checked="checked">Shouts</label>
				<label><input type="checkbox" id="Fusuarios" checked="checked">Usuarios</label>	
				<label><input type="checkbox" id="Ffotos" checked="checked">Fotos</label>
			</div>
		</div>	
	</div>
</div>	
