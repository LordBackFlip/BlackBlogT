                                ...
                                {if $tsSave}<div style="display: block;" class="mensajes ok">Tus cambios han sido guardados.</div>{/if}
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="report_{$r.t_id}">
                                                ...
                                                <td class="admin_actions">
                                                    ...
                                                    {if $tsUser->is_admod}<a href="{$tsConfig.url}/comunidades/{$r.c_nombre_corto}/editar-tema/{$r.t_id}/" target="_blank"><img src="{$tsConfig.default}/images/icons/edit.png" title="Editar Tema" /></a>{/if}
                                    ...
                                    <h2 style="border-bottom:1px dashed #CCC; padding-bottom:5px;">
                                        ...
                                        <span class="floatR admin_actions">
                                            ...
                                            {if $tsUser->is_admod}<a href="{$tsConfig.url}/comunidades/{$tsDenuncia.data.c_nombre_corto}/editar-tema/{$r.t_id}/" target="_blank"><img src="{$tsConfig.default}/images/icons/edit.png" title="Editar Tema" /></a>{/if}
                                    ...
                                    {/if}
{else}
	<div class="nada-gris" style="margin: -10px;">No hay temas denunciados</div>								
{/if}																		
                                </div>