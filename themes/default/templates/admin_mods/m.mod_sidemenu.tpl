...
// {/literal}
                                    ...
                                    <ul class="cat-list">
										...
										{*
										<li id="a_temas"><span class="cat-title"><a onclick="$('#a_temas').addClass('active');" href="{$tsConfig.url}/moderacion/temas">Shouts <span class="cadGe cadGe_{if $tsConfig.novemods.reptemas > 15}red{elseif $tsConfig.novemods.reptemas > 5}purple{else}green{/if}">{$tsConfig.novemods.reptemas}</span></a></span></li>
										*}
