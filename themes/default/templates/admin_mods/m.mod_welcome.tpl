...
<div id="res" class="boxy-content">
	<div class="boes">
		<b>Hola {$tsUser->nick}!</b>Si est&aacute;s viendo esto significa que tienes el privilegio de ser moderador en <strong>{$tsConfig.titulo}</strong>, por favor lee el protocolo de moderadores para mantener todo en orden.
	</div>
	<div style="border: 1px solid #d7d7d7;padding: 15px 20px;border-radius: 4px;margin: 20px 0 0 0;">
		<b>Protocolo</b>
		<ul id="reglas">
