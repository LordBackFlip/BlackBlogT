								...
								{if !$tsAdminNicks.data}
									<div class="nada-gris" style="margin: 10px;">No hay cambios esperando aprobaci&oacute;n</div>
								{else}
								...
								{/if}
								<div class="botoboc">
									<input type="button"  onclick="location.href = '{$tsConfig.url}/admin/nicks?act=realizados'" value="Ver decisiones tomadas" class="boton azul">
								</div>								
