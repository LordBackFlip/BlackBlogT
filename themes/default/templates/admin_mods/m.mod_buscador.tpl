...
<div id="res" class="boxy-content">
	{if !$tsAct}	
	<div class="boes">
		Esta herramienta le mostrar&aacute; las coindicencias del contenido o ip en una publicaci&oacute;n de un muro, usuario, post, foto o comentario.
	</div>	
	<div class="box-ver">
		<h2>IP</h2>
		<div class="muvx">
			<p>Se mostrar&aacute; todo el contenido relacionado con la IP introducida, si es parecida (parcial), o exactamente la misma (exacta).</p>
		</div>
	</div>
	<div class="box-ver">
		<h2>Texto</h2>
	...
	<div class="nesle">
		<form action="" method="post">			
			<input type="submit" name="buscar" value="Buscar Contenido" class="boto azul"/>
	...
	{elseif $tsAct == 'search'}
	<div class="nesle">
		<form action="" method="post" style="margin: 0 0 10px 0;">
			<input type="submit" name="buscar" value="Buscar Contenido" class="boto azul"/>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="admin_table" width="100%" align="center" id="usuarios">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="http://es.geoipview.com/?q={$u.user_last_ip}" class="geoip" title="Información de IP" target="_blank">{$u.user_last_ip}</a></td>
									...
									<table cellpadding="0" cellspacing="0" border="0" class="admin_table" width="100%" align="center" id="muro">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{$m.p_body}</td>
												<td><a href="http://es.geoipview.com/?q={$m.p_ip}" class="geoip" title="Información de IP" target="_blank">{$m.p_ip}</a></td>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="admin_table" width="100%" align="center" id="posts">
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="report_{$r.obj_id}">
                                                ...
                                                <td><a href="http://es.geoipview.com/?q={$p.post_ip}" class="geoip" title="Información de IP" target="_blank">{$p.post_ip}</a></td>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="admin_table" width="100%" align="center" id="fotos">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="http://es.geoipview.com/?q={$f.f_ip}" class="geoip" title="Información de IP" target="_blank">{$f.f_ip}</a></td>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="admin_table" width="100%" align="center" id="p_comentarios">
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="comentario_{$c.cid}">
                                                ...
                                                <td><a href="http://es.geoipview.com/?q={$c.c_ip}" class="geoip" title="Información de IP" target="_blank">{$c.c_ip}</a></td>
