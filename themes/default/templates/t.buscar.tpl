...
<div id="bushome">
	<span id="tipo"></span>
	<form name="buscador" action="/buscar/posts/" method="GET">
...
{elseif $tsAction == 'posts'}
	{if $tsAutor}
		{include file='modules/m.resultados_buscar_posts.tpl'}
	{else}
		{if !$tsPalabra}
			<div id="bushome">
				<span id="tipo"></span>
...
{elseif $tsAction == 'mi'}
	...
	{else}	
		{include file='modules/m.resultados_buscar_shouts.tpl'}
	{/if}	
{elseif $tsAction == 'imagenes'}
{if !$tsPalabra}
	<div id="bushome">
		<span id="tipo"></span>
		<form name="buscador" action="" method="GET">
	...
	{else}	
		{include file='modules/m.resultados_buscar_imagenes.tpl'}
	{/if}
{/if}
                    ...
                    <tr id="div_{$r.post_id}">
                        ...
                        <td style="text-align: left;">
                            ...
                            <div class="info" style="background-color:#FFF">
                                ...
                                <img alt="Posts relacionados" src="{$tsConfig.tema.t_url}/images/icons/relacionados.png"/> <a href="{$tsConfig.url}/buscar/?q={$r.post_title}&e={$tsEngine}&cat={$tsCategory}&autor={$tsAutor}">Post Relacionados</a> -
