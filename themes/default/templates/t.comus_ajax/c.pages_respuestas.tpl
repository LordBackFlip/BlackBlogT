...
<div class="ctc_coment_list">
    ...
    <div class="com_coment_resp clearfix" id="coment_id_{$r.r_id}">
        ...
        <ul class="ccr_options clearfix">
            ...
            <li><a onclick="com.votar_respuesta({$r.r_id}, 'pos');return false;" class="qtip" title="Me gusta"><i class="com_icon icon_like"></i></a></li>
            <li><a onclick="com.votar_respuesta({$r.r_id}, 'neg');return false;" class="qtip" title="No me gusta"><i class="com_icon icon_dislike"></i></a></li>
            <li><a onclick="com.citar_com({$r.r_id}, '{$r.user_name}');return false;" class="qtip" title="Responder"><i class="com_icon icon_reply"></i></a></li>
