<div class="com_members_filter clearfix">
    ...
    <ul class="cmf_select clearfix floatR">
        ...
        <li {if $tsMisComus.orden == 'miembro'}class="active"{/if}><a href="{$tsConfig.url}/comunidades/mis-comunidades/miembro">Miembros</a></li>
...
<div id="com_members_result">
    ...
    <div class="com_list_members clearfix">
    	<div class="clm_avatar floatL">
			<a href="{$tsConfig.url}/comunidades/{$m.c_nombre_corto}/">
				<img src="{$tsConfig.url}/files/uploads/c_{$m.c_id}.jpg"/>
			</a>
		</div>
