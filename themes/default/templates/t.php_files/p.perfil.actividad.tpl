...
<div id="perfil_actividad" status="activo">
    <div class="widget big-info clearfix">
		<div class="titular" style="margin-bottom: 5px;">
			<h2>&Uacute;ltima actividad de {$tsUsername}</h2>
        ...
        {else}
        <div class="nada-gris" style="margin:5px 0 0 0;">Este usuario no tiene actividad</div>
        {/if}
    </div>
</div>
{else}
